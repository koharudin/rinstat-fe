...
export default async () => {
    const getData = async () => {
        try {
            ...
            console.log('fetching to  ' + process.env.BACKEND_URL);
            const response = await fetch(process.env.BACKEND_URL + '/rin/get-all-count-downloads');
    ...
    return (
        <div>
            ...
            <div className="panel mt-6">Data {data?.total}</div>
        </div>
    );
};
